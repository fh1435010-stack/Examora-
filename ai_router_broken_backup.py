...
# Set GEMINI_MODEL in the environment.
# This fallback can be changed when you choose your model.
...
UNIVERSAL OPENAI-COMPATIBLE PROVIDER FUNCTION

Used for providers with a /chat/completions-style API.
...
# If one provider succeeds:
# Return immediately

# If every provider fails:
# Return all errors safely
